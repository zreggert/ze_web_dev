            ...
            >
                ...
                <div className="flex rounded-lg shadow-lg bg-slate300 justify-center items-center">
                    <div className="flex flex-col mx-8 mt-3 pb-10 gap-8 ">
                        ...
                        <p className="text-md">Hi, I&apos;m Zack, a web developer out of Atlanta, Georgia. During the pandemic in 2020, after spending many years bartending and working as a service industry professional, I decided to pursue a career in tech. I began self paced online course and eventually enrolled and received a certificate in Full Stack Web Development through the Georgia Institute of Technology. Since then, I have worked in Tech Support and Network Operations in the financial tech industry. While the experience has been great, I am trying to turn my attention back to web and software development and am continuing my education in those areas. I&apos;ve recently updated my portfolio and am beginning work on new personal and professional projects I will showcase here. If you like what you see please feel to contact me!</p>
                        <p className="text-md">Outside of my professional career I am a active person and enjoy many hobbies including hiking, biking, jiu jitsu, and TTRPGs. I absolutely love traveling and am hoping that I&apos;ll soon be able to start planning my next big adventure.</p>
                    </div>
                </div>
            </div>
        </motion.div>
