...
const Portfolio = () => {
	...
	// 
	return (
		<motion.div ref={targetRef} style={{ opacity }} className="flex flex-col justify-center items-start bg-lightgray bg-opacity-5 my-24 py-6 gap-20 xl:h-screen" id="portfolio">
			<div className=" flex flex-col mx-6 md:mx-16 lg:mx-36 px-8 lg:px-24">
